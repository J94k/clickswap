...
import { ThemeContext } from 'styled-components' // styled
import { Field } from '../../state/swap/actions'
import { useUserSlippageTolerance } from '../../state/user/hooks'
import { TYPE } from '../../theme' // { ExternalLink }
    ...
    <AutoColumn gap="md">
      {trade && (
        <>
          ...
          {/* <AutoColumn style={{ padding: '0 24px' }}>
            <InfoLink
              href={'https://info.clickswap.cloud/pair/' + trade.route.pairs[0].liquidityToken.address}
              target="_blank"
            >
              View pair analytics ↗
            </InfoLink>
