...
import { BigintIsh, currencyEquals, JSBI, Pair, Percent, Token, TokenAmount, Trade, WETH } from '@uniswap/sdk'
...
import { useTokenBalances } from '../state/wallet/hooks' // {useETHBalances, useTokenBalance,}
